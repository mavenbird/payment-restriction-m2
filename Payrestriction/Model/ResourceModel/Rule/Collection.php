...
namespace Mavenbird\Payrestriction\Model\ResourceModel\Rule;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Mavenbird\Payrestriction\Model\Rule::class,
            \Mavenbird\Payrestriction\Model\ResourceModel\Rule::class
        );
