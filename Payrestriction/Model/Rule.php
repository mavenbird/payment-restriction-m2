...
class Rule extends \Magento\Rule\Model\AbstractModel
{
    ...
    /**
     * @var \Mavenbird\Payrestriction\Model\Modifiers\Subtotal
     */
    ...
    public function __construct(
        ...
        \Mavenbird\Payrestriction\Model\Rule\Condition\Combine $conditionCombine,
        \Mavenbird\Payrestriction\Model\Rule\Condition\Product\Combine $conditionProductCombine,
        \Mavenbird\Payrestriction\Model\Modifiers\Subtotal $subtotalModifier,
        \Mavenbird\Payrestriction\Model\Validator\Backorder $backorderValidator,
        $resource = null,
        array $data = []
    ) {
    ...
    {
        $this->_init('Mavenbird\Payrestriction\Model\ResourceModel\Rule');
    }
    ...
    public function match($rate)
    {
        ...
        /**
         * Checks if the carrier code contains an underscore, which indicates it is a combined carrier and method.
         *
         * @param \Magento\Quote\Model\Quote\Address\RateResult\Method $rate The shipping rate to check.
         * @return bool True if the carrier code does not contain an underscore, false otherwise.
         */
