 ...
 * @copyright Copyright (c) 2020 Mavenbird (https://www.maenbird.com)
...
use Mavenbird\Payrestriction\Model\RegistryConstants as PayrestrictionRegistryConstants;
/**
 * @deprecated
...
class Conditions extends AbstractTab
{
    ...
    protected function formInit($model)
    {
        ...
        $renderer = $this->rendererFieldset->setTemplate(
            ...
            $this->getUrl('maenbird_rules/rule/newConditionHtml', ['form' => self::RULE_CONDITIONS_FIELDSET_NAMESPACE])
        );
